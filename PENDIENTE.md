...
- Últimos commits relevantes:
  - Ola 5 ítem 11: **Exposición y concentración por país** — `get_concentracion` agrega el
    eje "País" (HHI, bucket "Sin país"); `score_diversificacion` lo suma si hay ≥2 países.
    `get_exposicion` ya lo tenía. Sin cambio de frontend.
...
- Tests backend: **298 pasan, 0 fallan** (+25 con Ola 4; +7 ítem 5:
  ...
  `test_market_data.py`; +4 ítem 11: `test_concentracion_pais.py` + 2 en `test_diagnostico_engine.py`).
...
10. ~~Riesgo país + inflación mensual en Indicadores Macro~~ ✅ ·
11. ~~Exposición/concentración por país~~ ✅ — **Ola 5 completa**.
