...
export const WATCHLIST_HELP: Record<WatchlistHelpKey, HelpContent> = {
  watchlist_precio_objetivo: {
    ...
    shortDescription: 'El precio al que querés comprar el instrumento. Lo cargás vos al agregarlo (o tocando la fila), siempre como un valor fijo: acá no hay precio de compra previo del que partir, así que no admite modo Porcentaje.',
  ...
  watchlist_zona_compra: {
    ...
    limitations: 'Usa el último precio registrado, no una cotización en vivo. Un instrumento sin Objetivo cargado nunca va a avisar. Es sólo una señal, no ejecuta ninguna compra.',
