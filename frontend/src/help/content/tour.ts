...
export const TOUR_BIENVENIDA: PasoTour[] = [
  ...
  },
  {
    ...
    texto:
      'Las cuatro pantallas más usadas están siempre a mano. El resto —34 pantallas en total— vive agrupado por tema en "Más", y también se puede buscar con la lupa.',
  },
  {
    emoji: '🔄',
