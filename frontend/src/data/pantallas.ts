...
export const GRUPOS_PANTALLAS: GrupoPantallas[] = [
  ...
  },
  {
    titulo: 'Herramientas',
    items: [
      { to: '/simulador', label: 'Simulador', desc: '"¿Qué pasaría si…?" — sencillo o avanzado', icon: 'edit' },
      ...
      { to: '/screener', label: 'Screener', desc: 'Qué acciones están cerca de disparar una estrategia guardada', icon: 'search' },
    ],
  },
  {
    titulo: 'Sistema',
