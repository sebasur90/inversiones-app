  ...
  return (
    <div className="bg-app-surface border border-app-border rounded-lg p-3 mb-2">
      <div className="flex items-start justify-between gap-2 mb-1">
        <div className="text-[12px] font-mono text-app-text-dim">
      ...
      <div className="text-[13px] text-app-text font-medium mb-1">{issue.mensaje}</div>
      {issue.campo && <div className="text-[11px] text-app-text-dim mb-0.5">Campo: {issue.campo}</div>}
      <div className="text-[11px] text-app-text-dim">Impacto: {issue.impacto}</div>
    </div>
  )
}
